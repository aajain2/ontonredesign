...
export default function SurfaceCard({ surface }) {
  const { title, type, thumbnails, canvasColor } = surface

  // Use first thumbnail as cover, or canvas color for rooms, or fallback
  const coverBg =
  ...
  return (
    <div className="flex-shrink-0 w-[280px] group cursor-pointer">
      {/* Cover image — rectangular, slight rounding like Are.na */}
      <div
      ...
      {/* Info row: avatar + title + @username */}
      <div className="mt-3 flex items-center gap-2.5">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[12px] text-[#8A8580] truncate leading-tight">@user</p>
        </div>
        <button
